    ...
    <div class="container mt-4">
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card bg-dark text-white" style="width: 18rem;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item bg-dark text-white"><img src="imgpacks/proximamente.png" alt="..." class="img-fluid" width="250px"></li>
                    </ul>
                    <div class="card-body">
                        <center><h5 class="card-title">PROXIMAMENTE</h5>
                        <p class="card-text">Aun no se sabrá de que será el siguiente pack.<br>
                        <small>0 canciones</small></p></center>
                        <br>
                    </div>
                    <ul class="list-group list-group-flush">
                        <br>
                        <center>
                            <a href="#" class="btn btn-primary disabled" aria-disabled="true">Ver Canciones</a>
                            <a href="#" class="btn btn-danger disabled" aria-disabled="true">Descargar</a>
                        </center>
                        <br>
                    </ul>
                </div>
